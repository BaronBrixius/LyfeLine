...
public class EventEditor {
    ...
    @FXML
    private void uploadImage() throws IOException, SQLException {    //Only working now for .jpg
        ...
        if (this.imageChosen != null) {
            if (event.getImagePath() == null) {
                ...
                ////////////////////////////////////////////////////////////////////////
                ///////////////////////////////////////////////////////////////////////
                System.out.println("full " + this.imageChosen.getAbsolutePath());
    ...
    private boolean saveConfirm() throws IOException {
        ...
        //To delete image from DB Firas
        /*else if (result.get() == ButtonType.OK&&event.getImagePath()!=null) {
            String delete = fullOutPath;
            System.out.println(delete);
            File deleteit = new File(delete);
            deleteit.deleteOnExit();
        }*/
        return saveEvent();
    }
    ...
    void updateEvent() throws IOException {
        ...
        ///////////////////////////////////////////////////////////////////
        ///////////////BIG Error her//////////////////////////////////
       // event.setImage(this.imageChosen.getAbsolutePath());
        this.event.setImage("");
        this.event.setImage(this.fullOutPath);
        System.out.println("update "+this.fullOutPath);
