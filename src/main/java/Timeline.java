...
public class Timeline implements DBObject<Timeline>{
	...
	public Timeline(int TimeLineID, String TimelineName, String TimelineDescription, int Scale, String Theme, Date StartDate, Date Enddate, Date DateCreated, int TimelineOwner, boolean Private) {
