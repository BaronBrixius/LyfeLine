...
VALUES (01, 1, 'Fall of Rome', 'Out with a wimper, not a bang', 'dark', -350, 5, 20, 4, 43, 32, 213, 2001, 5, 20, 4, 43, 32, 213, 2000, 5, 20, 4, 43,
        32, 213, default, 1),
       (02, 7, 'New Timeline', '', 'dark', 2020, 5, 20, 4, 43, 32, 213, 2005, 5, 20, 4, 43, 32, 213, 2003, 5, 20, 4,
        43, 32, 213, default, 1),
       (03, 6, 'Hound of Baskervilles', 'Investigation of an attempted murder', 'light', 1902, 5, 20, 4, 43, 32, 213, 2006, 5, 20, 4, 43, 32, 213, 2003, 5, 20, 3,
        43, 32, 213, default, 2),
       (04, 5, 'Dr. Strangelove', 'A dark comedy on nuclear war', 'dark', 1987, 5, 20, 4, 43, 32, 213, 2008, 5, 20, 4, 43, 32, 213, 2007, 5, 20, 4, 43,
        32, 213, default, 2),
       (05, 4, 'New Timeline1', '', 'light', 2020, 5, 20, 4, 43, 32, 213, 2009, 5, 20, 4, 43, 32, 213, 2008, 5, 20, 4,
        43, 32, 213, default, 3),
       (06, 3, 'Bronze Age Collapse', 'When civilization reset', 'light', -13000, 5, 20, 4, 43, 32, 213, 2010, 5, 20, 4, 43, 32, 213, 2009, 5, 20, 4,
        43, 32, 213, default, 4),
       (07, 2, 'Life of Bacillus', 'Life and times of a bacterium', 'mad', 2020, 5, 20, 4, 43, 32, 213, 1505, 5, 20, 4, 43, 32, 213, 2000, 5, 20, 4, 46,
        32, 213, default, 5),
       (08, 1, 'Decay of Ununoctium', 'Radioactive decay - a study', 'dark', 2020, 5, 20, 4, 43, 32, 213, 1555, 5, 20, 4, 43, 32, 213, 1550, 5, 20, 4, 43,
        32, 213, default, 6)
;
