...
public class DBM {
    ...
    private static String PASS = "AJnuHA^8VKHht=uB";//AJnuHA^8VKHht=uB
    ...
    public static void useSchema(String SCHEMA) throws SQLException {                  //swaps to a different schema, creating it if it doesn't exist
    ...
    public static void runScript(String creationScript) throws FileNotFoundException, SQLException {      //private read-in method for DB creation script
    ...
    public static <T> void insertIntoDB(List<T> insert) throws SQLException {            //converts to array so it works with varargs
    ...
    public static <T> DBObject<T>[] asArray(List<T> list) {                                    //converts generic List to Array since normal methods hate casting like that
        try {
