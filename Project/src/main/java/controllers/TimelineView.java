...
public class TimelineView {
	...
	public void snapshot() throws IOException {		//TODO fix cancelling in the filechooser
		...
		if (!nopic & beige) {
			...
			// timelineGrid.setBackground(new Background(new
			// BackgroundFill(javafx.scene.paint.Paint.valueOf("#c7c3ad"),
			// CornerRadii.EMPTY, Insets.EMPTY)));
			// mainScrollPane.setBackground(new Background(new
			// BackgroundFill(javafx.scene.paint.Paint.valueOf("#c7c3ad" ),
			// CornerRadii.EMPTY, Insets.EMPTY)));
	...
	private void zoom(ScrollEvent event) {
		...
		if (newScale < .001) // min zoom is 1/100x
			newScale = .001; // TODO ask client if he's sure he wants no minimum zoom, even at this point
								// each bar is less than a pixel tall, i.e. near invisible
